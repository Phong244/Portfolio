...
const Header = () => {
  return (
    <header className="w-full h-screen bg-darkBlue relative">
      ...
      <div className="inner absolute top-2 right-8 z-50 bg-green-alt rounded-lg max-w-[250px] p-8 clip-circle-sm hover:clip-circle-lg transition-all duration-500">
      ...
      <div className="landing-text absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center w-full z-10 select-none">
        <h1 className="text-8xl md:text-[10rem] font-['the_historia_demoregular',sans-serif] p-4 bg-gradient-to-t from-mainColor to-secondColor bg-clip-text text-transparent tracking-widest">
          Phong Le
        </h1>
