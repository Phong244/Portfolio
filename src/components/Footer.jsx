...
const Footer = () => {
  return (
    <footer className="footer bg-bg py-20 px-4 md:px-20 relative z-10">
      <hr className="border-whiteLight border-opacity-40 mb-16" />
      <div className="footer-head mt-8 text-base font-medium">
        <h5 className="uppercase tracking-[.2em] mb-4">Thanks for visiting!</h5>
        <div className="link-container text-thirdColor flex flex-wrap">
          <div className="footer-links mb-12 md:mb-0 md:mr-60">
      ...
      <div className="footer-copy text-whiteLight pt-36 text-right text-base">
        &copy; Phong Le 2026
      </div>
    </footer>
  );
